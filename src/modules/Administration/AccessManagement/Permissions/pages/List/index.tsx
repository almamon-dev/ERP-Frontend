...
export default function PermissionList() {
    const [data, setData] = useState([
        { id: 1, name: 'Sample Permission 1', code: 'CODE_001', status: 'Active', createdAt: '2026-07-10' },
        { id: 2, name: 'Sample Permission 2', code: 'CODE_002', status: 'Inactive', createdAt: '2026-07-12' },
    ]);
        ...
        <div className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                    ...
                    <Input defaultValue={isEdit ? editItem?.name : ''} placeholder="Enter Permission Name" />
                </div>
                <div className="col-span-2">
            ...
            <div className="p-4 bg-slate-50 border border-slate-100 rounded-md flex items-center justify-between">
                <div>
                    ...
                    <p className="text-[12px] text-slate-500 mt-0.5">Is this permission active in the system?</p>
                </div>
    ...
    return (
        <div className="p-6 md:p-8 mx-auto bg-[#f8f9fa] min-h-screen pb-24">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-[22px] font-bold text-slate-900">Permissions</h1>
                    <p className="text-[14px] font-medium text-[#008060] mt-1">Manage system permissions and access levels.</p>
                </div>
                <Button 
