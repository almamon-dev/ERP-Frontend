...
import { ArrowLeft, Save, Building2, Phone, Briefcase, ChevronRight, Image, Paperclip, FileText, Activity } from 'lucide-react';
                                ...
                                <div className="space-y-3 w-full">
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="w-16 h-16 rounded-lg border-2 border-dashed border-slate-300 flex items-center justify-center bg-slate-50 text-slate-400">
                                                <Image size={24} />
                                            </div>
                                            <div>
                                                <Button variant="outline" size="sm" className="h-[30px] text-[12px] font-semibold">Update Logo</Button>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                                        ...
                                        <div className="col-span-1 md:col-span-2 pt-1">
                                            ...
                                            <Input placeholder="e.g. Technology, Healthcare, Manufacturing" className="h-[38px] text-[13px]" defaultValue="Technology" />
                                        </div>
                                        <div className="col-span-1 md:col-span-2">
                                            <label className="block text-[13px] font-medium text-slate-700 mb-1.5">Short Description</label>
                                            <Textarea placeholder="A brief description of what the company does..." rows={2} className="text-[13px]" defaultValue="A leading enterprise solutions provider." />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3 animate-in fade-in duration-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 w-full">
                                    ...
                                    <div>
                                        ...
                                        <Input type="email" placeholder="contact@company.com" className="h-[38px] text-[13px]" defaultValue="contact@enterprise.com" />
                                    </div>
                                    <div>
                                        <label className="block text-[13px] font-medium text-slate-700 mb-1.5">Phone Number <span className="text-red-500">*</span></label>
                                        <Input placeholder="+1 (555) 000-0000" className="h-[38px] text-[13px]" defaultValue="+1 234 567 8900" />
                                    </div>
                                    <div className="col-span-1 md:col-span-2">
                                        <label className="block text-[13px] font-medium text-slate-700 mb-1.5">Primary Website</label>
                                        <Input placeholder="https://www.example.com" className="h-[38px] text-[13px]" defaultValue="https://www.enterprise.com" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <Select value="US" className="h-[38px]">
                                    ...
                                    <div>
                                        ...
                                        <Input placeholder="State name" className="h-[38px] text-[13px]" defaultValue="NY" />
                                    </div>
                                    <div>
                                        <label className="block text-[13px] font-medium text-slate-700 mb-1.5">City <span className="text-red-500">*</span></label>
                                        <Input placeholder="City name" className="h-[38px] text-[13px]" defaultValue="New York" />
                                    </div>
                                    <div>
                                        <label className="block text-[13px] font-medium text-slate-700 mb-1.5">ZIP / Postal Code</label>
                                        <Input placeholder="ZIP Code" className="h-[38px] text-[13px]" defaultValue="10001" />
                                    </div>
                                    <div className="col-span-1 md:col-span-2">
                                        ...
                                        <Textarea placeholder="Enter full street address" rows={2} className="text-[13px]" defaultValue="123 Business Avenue, Suite 100" />
                                    </div>
                                </div>
                            </div>
                        )}
                            ...
                            <div className="space-y-3 animate-in fade-in duration-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 w-full">
                                    ...
                                    <div>
                                        ...
                                        <Select value="USD" className="h-[38px]">
                                    ...
                                    <div>
                                        ...
                                        <Select value="en" className="h-[38px]">
                                    ...
                                    <div>
                                        ...
                                        <Select value="EST" className="h-[38px]">
                                    ...
                                    <div>
                                        ...
                                        <Select value="YYYY-MM-DD" className="h-[38px]">
                                    ...
                                    <div className="col-span-1 md:col-span-2">
                                        ...
                                        <Input placeholder="Full registered legal entity name" className="h-[38px] text-[13px]" defaultValue="Global Enterprise Limited Corporation" />
                                    </div>
                                    <div>
                                        <label className="block text-[13px] font-medium text-slate-700 mb-1.5">Registration Number</label>
                                        <Input placeholder="Business Reg Number" className="h-[38px] text-[13px]" defaultValue="REG-9912039" />
                                    </div>
                                    <div>
                                        <label className="block text-[13px] font-medium text-slate-700 mb-1.5">Tax / VAT Number</label>
                                        <Input placeholder="Tax Identification Number" className="h-[38px] text-[13px]" defaultValue="TAX-445582" />
                                    </div>
                                    <div>
                                        <label className="block text-[13px] font-medium text-slate-700 mb-1.5">Fiscal Year <span className="text-red-500">*</span></label>
                                        <Select value="January" className="h-[38px]">
                        ...
                        {activeTab === 'files' && (
                            <div className="space-y-3 animate-in fade-in duration-300">
                                <div className="mb-6 pb-4 border-b border-slate-100">
                                    ...
                                    <p className="text-[13px] text-slate-500 mt-1">Document uploads, internal notes, and system history.</p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 w-full">
                                    <div className="col-span-1 md:col-span-2">
                                        ...
                                        <div className="border-2 border-dashed border-slate-300 rounded-md p-4 flex flex-col items-center justify-center bg-[#fafafa] hover:bg-slate-100 transition-colors cursor-pointer text-slate-500 h-24">
                                            ...
                                            <p className="text-[11px] text-slate-500">Business_Registration_2025.pdf (2.4 MB)</p>
                                        </div>
                                    </div>
                                    <div className="col-span-1 md:col-span-2">
                                        <label className="block text-[13px] font-medium text-slate-700 mb-1.5">Internal Notes</label>
                                        <Textarea placeholder="Add any private notes or context about this company..." rows={2} className="text-[13px]" defaultValue="Top tier partner." />
                                    </div>

                                    <div className="col-span-1 md:col-span-2">
                                        <h3 className="text-[14px] font-bold text-slate-800 mb-4 mt-2 flex items-center gap-2">
                                            <Activity size={16} className="text-slate-500"/> System Activity
                                        </h3>
                                        <div className="bg-slate-50 border border-slate-200 rounded-md p-3">
                                            <div className="grid grid-cols-2 gap-y-2 text-[12px]">
                                                <div className="text-slate-500">Created At</div>
                                                <div className="font-medium text-slate-800">Oct 12, 2025 - 14:30 PM</div>
                                                <div className="text-slate-500">Last Modified</div>
                                                <div className="font-medium text-slate-800">Nov 05, 2025 - 09:15 AM</div>
                                                <div className="text-slate-500">System ID</div>
                                                <div className="font-medium font-mono text-slate-800">e8f7a932-b2d9-45e0-91c2</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
