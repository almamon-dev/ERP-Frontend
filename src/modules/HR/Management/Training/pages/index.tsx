...
export default function TrainingProgramsPage() {
    ...
    return (
        <div className="p-4 md:p-6 max-w-full mx-auto bg-[#f8f9fa] min-h-screen pb-20">
            ...
            <FormModals title="Training Programs" isCreateOpen={isCreateModalOpen} onCloseCreate={() => setIsCreateModalOpen(false)} editItem={editItem} onCloseEdit={() => setEditItem(null)} />
        </div>
    );
}
