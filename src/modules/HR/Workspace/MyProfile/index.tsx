  ...
  return (
    <div className="p-4 md:p-6 max-w-full mx-auto bg-[#f8f9fa] min-h-screen">
      <div className="mb-5">
        ...
        <p className="text-[13px] font-medium text-[#008060] mt-0.5">Manage personal information, emergency contacts, and job details.</p>
      </div>
      <div className="bg-white p-6 rounded-[3px] border border-slate-200 shadow-2xs">
        <p className="text-slate-600 text-[13px]">My Profile module loaded successfully.</p>
      </div>
    </div>
  );
}
